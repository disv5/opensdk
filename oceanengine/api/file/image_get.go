...
// 获取图片素材数据目前仅支持10000个！
func ImageGet(clt *core.SDKClient, accessToken string, req *file.ImageGetRequest) (*file.ImageGetResponseData, error) {
	var resp file.ImageGetResponse
	err := clt.Get("2/file/image/get/", req, &resp, accessToken)
	if err != nil {
		return nil, err
	}
