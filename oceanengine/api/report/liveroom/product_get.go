...
func ProductGet(clt *core.SDKClient, accessToken string, req *liveroom.Request) (*liveroom.ResponseData, error) {
	var resp liveroom.Response
	err := clt.Get("2/report/live_room/product/get/", req, &resp, accessToken)
	if err != nil {
		return nil, err
	}
