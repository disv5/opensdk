...
func TrackURLUpdateStatus(clt *core.SDKClient, accessToken string, req *adconvert.TrackURLUpdateRequest) error {
	return clt.Post("2/tools/ad_convert/track_url/update/", req, nil, accessToken)
}
