...
func MaterialBind(clt *core.SDKClient, accessToken string, req *file.MaterialBindRequest) ([]file.FailedMaterialBind, error) {
	var resp file.MaterialBindResponse
	err := clt.Post("2/file/material/bind/", req, &resp, accessToken)
	if err != nil {
		return nil, err
	}
	if resp.Data == nil {
