...
func AwemeAuthorInfoGet(clt *core.SDKClient, accessToken string, req *aweme.AwemeAuthorInfoGetRequest) ([]aweme.Author, error) {
	var resp aweme.AwemeAuthorInfoGetResponse
	err := clt.Get("2/tools/aweme_author_info/get/", req, &resp, accessToken)
	if err != nil {
		return nil, err
	}
