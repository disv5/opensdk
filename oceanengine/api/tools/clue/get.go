...
func Get(clt *core.SDKClient, accessToken string, req *clue.GetRequest) (*clue.GetResponseData, error) {
	var resp clue.GetResponse
	if err := clt.Get("2/tools/clue/get/", req, &resp, accessToken); err != nil {
		return nil, err
	}
