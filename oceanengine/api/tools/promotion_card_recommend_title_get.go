...
func PromotionCardRecommendTitleGet(clt *core.SDKClient, accessToken string, req *tools.PromotionCardRecommendTitleGetRequest) ([]string, error) {
	var resp tools.PromotionCardRecommendTitleGetResponse
	if err := clt.Get("2/tools/promotion_card/recommend_title/get/", req, &resp, accessToken); err != nil {
		return nil, err
	}
