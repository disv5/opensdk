...
func Read(clt *core.SDKClient, accessToken string, req *adconvert.ReadRequest) (*adconvert.Convert, error) {
	var resp adconvert.ReadResponse
	err := clt.Get("2/tools/ad_convert/read/", req, &resp, accessToken)
	if err != nil {
		return nil, err
	}
