...
import (
	...
	"donson.com.cn/draining/internal/pkg/oceanengine/model/tools/sitetemplate"
)
...
func Create(clt *core.SDKClient, accessToken string, req *sitetemplate.CreateRequest) (*sitetemplate.Template, error) {
	var resp sitetemplate.CreateResponse
	if err := clt.Post("2/tools/site_template/create/", req, &resp, accessToken); err != nil {
		return nil, err
	}
