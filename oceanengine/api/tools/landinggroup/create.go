...
func Create(clt *core.SDKClient, accessToken string, req *landinggroup.CreateRequest) (*landinggroup.LandingGroup, error) {
	var resp landinggroup.CreateResponse
	if err := clt.Post("2/tools/landing_group/create/", req, &resp, accessToken); err != nil {
		return nil, err
	}
