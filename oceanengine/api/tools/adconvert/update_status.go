...
func UpdateStatus(clt *core.SDKClient, accessToken string, req *adconvert.UpdateStatusRequest) error {
	return clt.Post("2/tools/ad_convert/update_status/", req, nil, accessToken)
}
