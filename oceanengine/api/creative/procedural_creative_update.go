...
func ProceduralCreativeUpdate(clt *core.SDKClient, accessToken string, req *creative.ProceduralCreativeUpdateRequest) error {
	return clt.Post("2/creative/procedural_creative/update/", req, nil, accessToken)
}
