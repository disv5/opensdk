...
func (t *Stat) IsEmptyData() bool {
	if t.Charge+float64(t.Bclick)+t.ActionRatio+float64(t.EventPay)+t.ConversionRatio+t.ConversionNumCost+float64(t.Aclick)+t.Click1KCost+t.ActionCost > 0 {
		return false
	}
