...
func ImageAdvertiser(clt *core.SDKClient, accessToken string, req *file.ImageAdvertiserRequest) (*file.Image, error) {
	var resp file.ImageAdvertiserResponse
	err := clt.Upload("2/file/image/advertiser/", req, &resp, accessToken)
	if err != nil {
		return nil, err
	}
