...
func Select(clt *core.SDKClient, accessToken string, req *adconvert.SelectRequest) (*adconvert.SelectResponseData, error) {
	var resp adconvert.SelectResponse
	err := clt.Get("2/tools/ad_convert/select/", req, &resp, accessToken)
	if err != nil {
		return nil, err
	}
