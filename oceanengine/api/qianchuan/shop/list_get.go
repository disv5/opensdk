...
func AdvertiserList(clt *core.SDKClient, accessToken string, req *shop.AdvertiserListRequest) (*shop.AdvertiserListResponseData, error) {
	var resp shop.AdvertiserListResponse
	err := clt.Get("v1.0/qianchuan/shop/advertiser/list/", req, &resp, accessToken)
	if err != nil {
		return nil, err
	}
