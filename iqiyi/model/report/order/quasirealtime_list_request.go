...
type QuasiRealTimeListRequest struct {
...
func (r QuasiRealTimeListRequest) Url() string {
	return "openapi/v1/report/quasiRealTime/order/list"
}

// Encode implement GetRequest interface
func (r QuasiRealTimeListRequest) Encode() []byte {
