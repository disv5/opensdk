...
func FormDetail(clt *core.SDKClient, accessToken string, req *clue.FormDetailRequest) (*clue.FormDetail, error) {
	var resp clue.FormDetailResponse
	if err := clt.Get("2/tools/clue/form/detail/", req, &resp, accessToken); err != nil {
		return nil, err
	}
