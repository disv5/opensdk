...
func CampaignAdd(clt *core.SDKClient, accessToken string, req *privativeword.CampaignAddRequest) (*privativeword.CampaignAddResponseData, error) {
	var resp privativeword.CampaignAddResponse
	err := clt.Post("2/privative_word/campaign/add", req, &resp, accessToken)
	if err != nil {
		return nil, err
	}
