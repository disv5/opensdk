...
func KeyActionGet(clt *core.SDKClient, accessToken string, req *clue.KeyActionGetRequest) (*clue.KeyActionGetResponseData, error) {
	var resp clue.KeyActionGetResponse
	if err := clt.Get("2/tools/key_action/get/", req, &resp, accessToken); err != nil {
		return nil, err
	}
