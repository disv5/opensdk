...
func AdUpdate(clt *core.SDKClient, accessToken string, req *privativeword.AdUpdateRequest) (uint64, error) {
	var resp privativeword.AdUpdateResponse
	err := clt.Post("2/privative_word/ad/update", req, &resp, accessToken)
	if err != nil {
		return 0, err
	}
