...
func FormGet(clt *core.SDKClient, accessToken string, req *clue.FormGetRequest) (*clue.FormGetResponseData, error) {
	var resp clue.FormGetResponse
	if err := clt.Get("2/tools/clue/form/get/", req, &resp, accessToken); err != nil {
		return nil, err
	}
