...
func AudiencesGet(clt *core.SDKClient, accessToken string, req *dmp.AudiencesGetRequest) (*dmp.AudiencesGetResponseData, error) {
	var resp dmp.AudiencesGetResponse
	err := clt.Get("v1.0/qianchuan/dmp/audiences/get/", req, &resp, accessToken)
	if err != nil {
		return nil, err
	}
