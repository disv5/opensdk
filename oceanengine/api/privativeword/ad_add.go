...
func AdAdd(clt *core.SDKClient, accessToken string, req *privativeword.AdAddRequest) (*privativeword.AdAddResponseData, error) {
	var resp privativeword.AdAddResponse
	err := clt.Post("2/privative_word/ad/add", req, &resp, accessToken)
	if err != nil {
		return nil, err
	}
